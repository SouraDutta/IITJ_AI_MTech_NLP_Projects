...
def parse_opt():
    ...
    parser.add_argument('--rnn_hidden_size', type=int, default=400, help='dimension of rnn in encoder and decoder')
    parser.add_argument('--att_hidden_size', type=int, default=400, help='dimension of the attention space')
    ...
    parser.add_argument('--rel_num', type=int, default=6, help='number of relation types')
    ...
    parser.add_argument('--neg_num', type=int, default=1, help='the number of negative sampling')
    ...
    parser.add_argument('--load_test', type=str, default='./save', help='path to load the model parameters, not including optimizer')
